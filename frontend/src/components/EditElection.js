...
import { addCandidate } from "./VotingSystemFunctions";
...
function EditElection() {
  ...
  const fetchElectionDetails = () => {
    axios
      .get(`/admin-api/elections/${electionTitle}`)
      .then((response) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    await addCandidate(newParticipant.name, "male", "bjp");
    axios
      .post(`/admin-api/elections/${electionTitle}/participants`, newParticipant)
      .then((response) => {
  ...
  const handleDeleteParticipant = (participantId) => {
    axios
      .delete(`/admin-api/elections/${electionTitle}/participants/${participantId}`)
      .then((response) => {
        console.log(response.data);
        fetchElectionDetails();
      })
